 ...
 */
define('PRODUCTION', TRUE); // pasar a FALSE para trabajar en modo DESARROLLO // pasar a TRUE para trabajar en modo PRODUCCION

/**
 * Descomentar para mostrar los errores
 */
//error_reporting(E_ALL ^ E_STRICT);ini_set('display_errors', 'On');
ini_set('display_errors', 'Off'); // OJO!! DESHABILITAR ESTA LINEA EN MODO DESARROLLO Y HABILITAR PARA PRODUCCION
...
define('APP_PATH', '/home/odontitnet/default/app/'); // OJO!! DESHABILITAR ESTA LINEA EN MODO DESARROLLO Y HABILITAR PARA PRODUCCIÓN
...
define('CORE_PATH', '/home/odontitnet/core/'); // OJO! HABILITAR PARA PRODUCCION - DESHABILITAR PARA DESARROLLO
...
define ('PUBLIC_PATH', 'https://www.odontit.net/'); // DESHABILITAR PARA DESARROLLO - HABILITAR PARA PRODUCCION
